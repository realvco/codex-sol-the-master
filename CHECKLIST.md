...
- [ ] Both README files expose the same top links, with a Taiwan flag plus `Traditional
      Chinese` approximately 20px and a United Kingdom flag plus `English` approximately
      24px, and link to each other.
